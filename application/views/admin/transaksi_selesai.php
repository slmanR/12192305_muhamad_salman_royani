...
<?php foreach ($peminjaman as $p) { ?>
    <form action="<?= base_url() . 'admin/transaksi_selesai_act' ?>" method="post">
        ...
        <input type="hidden" name="denda" value="<?php
                                                    echo $p->denda ?>">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="date" name="tgl_pinjam" value="<?=
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="denda" value="<?= $p->denda ?>" disabled>
        </div>
        <div class="form-group">
